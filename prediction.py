...
def prediction(s):
    ...
    EorI_model = joblib.load("./models/clf_is_Extrovert.joblib")
    SorN_model = joblib.load("./models/clf_is_Sensing.joblib")
    TorF_model = joblib.load("./models/clf_is_Thinking.joblib")
    JorP_model = joblib.load("./models/clf_is_Judging.joblib")
